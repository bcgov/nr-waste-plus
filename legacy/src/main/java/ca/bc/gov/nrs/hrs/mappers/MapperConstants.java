 ...
 * {@code CodeDescriptionDto} from a projection instance. The values are intended to be referenced
 * from mapper annotations (for example:
 * {@code expression = MapperConstants.STATUS_AS_DTO}).
 *
 * @since 1.0.0
 */
...
public class MapperConstants {
  ...
  /**
   * MapStruct expression to create a {@code CodeDescriptionDto} from the projection's district
   * code and district name. The district name has the "Natural Resource District" substring
   * removed and is trimmed.
   */
