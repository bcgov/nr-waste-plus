...
-- Table columns
CREATE TABLE THE.WASTE_SPONSOR (
	WASTE_SPONSOR_ID NUMBER(12,0),
	WASTE_ASSESSMENT_AREA_ID NUMBER(12,0),
	WASTE_SUBMITTER_ROLE_TYPE_CODE VARCHAR2(3),
	...
	WASTE_SUBMITTER_USER_GUID VARCHAR2(32),
	WASTE_SUBMITTER_USERID VARCHAR2(64),
	WASTE_SUBMITTER_NAME VARCHAR2(100),
	WASTE_SUBMITTER_PHONE VARCHAR2(10),
	WASTE_SUBMITTER_FAX VARCHAR2(10),
	WASTE_SUBMITTER_EMAIL VARCHAR2(128),
	CONSTRAINT WS_SYS_C0029442 CHECK ("WASTE_SPONSOR_ID" IS NOT NULL),
	CONSTRAINT WS_SYS_C0029443 CHECK ("WASTE_SUBMITTER_ROLE_TYPE_CODE" IS NOT NULL),
	CONSTRAINT WS_SYS_C0029444 CHECK ("REVISION_COUNT" IS NOT NULL),
	CONSTRAINT WS_SYS_C0029445 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT WS_SYS_C0029446 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT WS_SYS_C0029447 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT WS_SYS_C0029448 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT WS_PK PRIMARY KEY (WASTE_SPONSOR_ID)
);
CREATE INDEX WS_WAA_FK_I ON THE.WASTE_SPONSOR (WASTE_ASSESSMENT_AREA_ID);
CREATE INDEX WS_WDTC1_FK_I ON THE.WASTE_SPONSOR (WASTE_DESIGNATION_TYPE_CODE);
CREATE INDEX WS_WSRTC_FK_I ON THE.WASTE_SPONSOR (WASTE_SUBMITTER_ROLE_TYPE_CODE);
