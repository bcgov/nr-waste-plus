...
vi.mock('@/components/waste/Formula/FormulaConfigurationDetail/FormulaConfigurationDetailView', () => ({
...
vi.mock('@/components/waste/Formula/FormulaConfigurationDetail/FormulaConfigurationDetailSkeleton', () => ({
