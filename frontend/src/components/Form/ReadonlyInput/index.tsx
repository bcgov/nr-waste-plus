...
interface ReadonlyInputProps {
  ...
  /**
   * Additional CSS class name to be applied to the label.
   */
 ...
 *
 * @param {ReadonlyInputProps} props - The props for the component.
 * @returns {React.ReactElement} The rendered `ReadonlyInput` component.
 */
const ReadonlyInput = ({
  showSkeleton = false,
  label,
