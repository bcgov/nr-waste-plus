 ...
 * @param area the geographic area associated with the record (for example, "INTERIOR" or "COASTAL")
 * @param startDate the date on which the district volume record becomes effective
 * @param endDate the date on which the district volume record ceases to be effective; may be {@code
 *     null} if the record is currently active
