 ...
 *
 * <p>Used as an intermediate representation when fetching details directly from the legacy system,
 * before the data is enriched with information from the Forest Client API.
 *
