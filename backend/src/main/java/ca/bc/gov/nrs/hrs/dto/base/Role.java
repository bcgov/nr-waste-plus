...
/**
 * Enum representing all roles in the system, each associated with a {@link RoleType}. Used for
 * authorization checks in conjunction with Spring Security's @PreAuthorize.
 */
@Getter
