 ...
 *
 * <p>Holds standard OIDC identity claims as well as Cognito custom attributes ({@code
 * custom:idp_*}) that are present in the userInfo response but absent from access tokens. The
 * {@code groups} field maps to {@code cognito:groups} which Cognito may or may not include
