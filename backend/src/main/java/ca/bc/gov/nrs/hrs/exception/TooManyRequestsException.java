 ...
 *
 * <p>This extends {@link RetriableException} and is annotated with {@link ResponseStatus} to map to
 * HTTP 429 (Too Many Requests). The constructor accepts a retry-after value which is included in
 * the message.
 */
...
public class TooManyRequestsException extends RetriableException {
  ...
  public TooManyRequestsException(String entity, String retryAfter) {
    super(
        ...
        String.format("%s had too many requests, retry after %s", entity, retryAfter));
  }
}
