...
/**
 * Exception indicating a failed downstream request with a specific HTTP status code and diagnostic
 * value.
 *
 * <p>The exception message is formatted to include the status and the parameter/value that caused
 * the failure.
 */
