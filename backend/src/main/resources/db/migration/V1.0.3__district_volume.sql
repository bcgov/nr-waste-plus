...
CREATE INDEX idx_district_volume_data_gin
    ON district_volume USING gin(table_data);

-- Composite index for efficient "latest by area" queries
CREATE INDEX idx_district_volume_area_start_date
    ON district_volume (area, start_date DESC);