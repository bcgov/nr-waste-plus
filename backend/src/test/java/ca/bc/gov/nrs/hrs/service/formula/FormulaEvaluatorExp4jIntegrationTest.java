...
class FormulaEvaluatorExp4jIntegrationTest {
  ...
  void rejectsUnsupportedFunction() {
    ...
    assertThrows(
        ...
        () -> FormulaEvaluatorExp4j.evaluate(expression, variables));
  }
  ...
  void rejectsDivisionByZero() {
    String expr = "10 / 0";
    assertThrows(
        FormulaEvaluationException.class, () -> FormulaEvaluatorExp4j.evaluate(expr, Map.of()));
  }
  ...
  void rejectsNullExpression() {
    assertThrows(
        FormulaEvaluationException.class, () -> FormulaEvaluatorExp4j.evaluate(null, Map.of()));
  }

  @Test
  void rejectsBlankExpression() {
    assertThrows(
        FormulaEvaluationException.class, () -> FormulaEvaluatorExp4j.evaluate("", Map.of()));
  }
